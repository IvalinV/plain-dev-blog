...
<body class="min-h-screen bg-gray-50 text-gray-900 dark:bg-gray-950 dark:text-gray-100">
    <header class="border-b border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900">
        <div class="mx-auto flex max-w-3xl items-center justify-between px-4 py-6">
            ...
            >
                <span class="cursor-pointer dark:hidden" aria-hidden="true">🌙</span>
                <span class="hidden cursor-pointer dark:inline" aria-hidden="true">☀️</span>
            </button>
        </div>
    </header>
    <main class="mx-auto h-full max-w-3xl px-4 py-10">
        @yield('content')
    </main>
